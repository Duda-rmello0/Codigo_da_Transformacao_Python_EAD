...
def buscar_filme(nome_filme, api_key):
  ...
  try:
    res_generos = requests.get(url_generos, params=params_generos, timeout=10)
    ...
    generos_nomes = [mapa_generos.get(gid, "Desconhecido") for gid in genre_ids]
